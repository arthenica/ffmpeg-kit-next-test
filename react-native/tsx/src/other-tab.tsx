...
type OtherTabProps = TabProps<'OTHER'>;
...
export default class OtherTab extends React.Component<OtherTabProps, OtherTabState> {
    ...
    testChromaprint() {
        ...
        FFmpegKit.executeAsync(ffmpegCommand, async (session) => {
            ...
            if (ReturnCode.isSuccess(returnCode)) {
                ...
                }, log => this.appendOutput(log.getMessage() as string));
