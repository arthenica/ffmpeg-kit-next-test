...
type SubtitleTabProps = TabProps<'SUBTITLE'>;

interface SubtitleTabState {
    state: 'IDLE' | 'CREATING' | 'BURNING';
...
export default class SubtitleTab extends React.Component<SubtitleTabProps, SubtitleTabState> {

    private readonly progressModalReference: React.RefObject<ProgressModal | null>;
    private player: VideoRef | null = null;

    constructor(props: SubtitleTabProps) {
        super(props);
    ...
    getVideoWithSubtitlesFile(): string {
